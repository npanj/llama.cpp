...
llama_context::llama_context(
    ...
    // qwen4exp joins these: a "shared" mtp- sidecar omits token_embd/output and borrows the
    // target's, which are byte-identical and already resident. A full sidecar still carries its
    // own, and then ctx_other is neither required nor set.
